...
if (isset($_GET['delete'])) {
    ...
    header('location:admin_orders_cancelled.php'); 
    exit;
}

$select_orders = $conn->prepare("SELECT * FROM `orders` WHERE payment_status='cancelled' ORDER BY placed_on DESC");
...
<div class="main-content container-fluid py-4">
    <h1 class="text-center fw-bold mb-4"><i class="fas fa-ban me-2"></i> Cancelled Orders</h1>
    ...
    <div class="row g-4">
        <?php if($select_orders->rowCount() > 0): ?>
            ...
            <?php endwhile; ?>
        <?php else: ?>
            <p class="text-center p-5 bg-white shadow rounded">No cancelled orders found.</p>
        <?php endif; ?>
    </div>
</div>
